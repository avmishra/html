...
<h4>PHP server-side SDK</h4>

Braintree provides a PHP library.  Refer to the 
<a href="https://developers.braintreepayments.com/start/hello-server/php" target="_blank">Set Up Your Server</a> page 
...
<ol>
	...
	<li>Initialize the JavaScript client.
		<ul>
			<li>Your server needs to return an authorization token. See <span style="font-family: monospace;">bt-get-client-token.php</span>.</li>
		</ul>
	</li>
	...
	<li>
		Post the Payment Nonce and form data to server file <span style="font-family: monospace;">bt-transaction.php</span>.
	</li>
	<li>
		Submit the transaction. See <span style="font-family: monospace;">bt-transaction.php</span>.
	</li>
</ol>
