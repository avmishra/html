					...
					<div class="divBorder" style="min-height: 470px;">
						...
						<table class="table table-striped">
							...
							<tr>
								...
								<td>DSLR Camera, Auto-focus, A0123</td>
								<td>300.00</td>
							</tr>
						...
						<!-- Pay Now button  -->
					 	<div id="pay-now" style="display: none; text-align: center;">
							<form action="bt-transaction.php" method="post">
		...
		<script>
			...
			*/		
			braintree.client.create({
				...
				authorization: '<?php require_once('bt-get-client-token.php') ?>'
				...
				braintree.paypalCheckout.create({
					...
					paypal.Button.render({
						...
						payment: function () {
							...
							console.log('paymentFunction:', JSON.stringify(
                                {
                                    flow: 'checkout',
                                    intent: 'sale',
                                    amount: '300.00',
							...
							return paypalCheckoutInstance.createPayment({
								...
								currency: 'INR',
								locale: 'en_IN',
								displayName: 'Demo Portal Test Store 1',
								enableShippingAddress: true,
						...
						onError: function (err) {
							...
							console.error('onError: ', err.toString());
							var currentUrl = window.location.href = window.location.protocol + '//' + window.location.host + window.location.pathname;
							var errorUrl = currentUrl.substring(0, currentUrl.lastIndexOf('/')) + '/error.php?message=' + encodeURIComponent(err.toString());
