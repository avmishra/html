<?php
/**
 * Braintree - Payment Gateway integration (Hosted Fields) example
 * ==============================================================================
 * 
 * @version v1.0: braintree_hosted_fields_demo.php 2016/03/25
	...
	(function() {
		...
		BTFn.sendJSON = function($obj) {
			...
			$.ajax({
				...
				url: "braintree_hosted_fields_demo.php",
